...
regress yield_tons_hectare_2018 placebo_ndvi_2018, robust
local placebo = e(r2_a)
eststo: regress yield_tons_hectare_2018 max_ndvi_2018, robust
...
regress yield_tons_hectare_2018 placebo_gcvi_2018, robust
local placebo = e(r2_a)
eststo: regress yield_tons_hectare_2018 max_gcvi_2018, robust
local placebo_r2a: di %9.3fc  `placebo'
estadd local placebo_r2a `placebo_r2a'
local p_grid_fe: di %9.3fc `p_fe' 
estadd local p_grid_fe `p_grid_fe'
...
regress yield_tons_hectare_2018 placebo_re705_2018, robust
local placebo = e(r2_a)
eststo: regress yield_tons_hectare_2018 max_re705_2018, robust
local placebo_r2a: di %9.3fc  `placebo'
estadd local placebo_r2a `placebo_r2a'
local p_grid_fe: di %9.3fc `p_fe' 
estadd local p_grid_fe `p_grid_fe'
...
regress yield_tons_hectare_2018 placebo_mtci_2018, robust
local placebo = e(r2_a)
eststo: regress yield_tons_hectare_2018 max_mtci_2018, robust
local placebo_r2a: di %9.3fc  `placebo'
estadd local placebo_r2a `placebo_r2a'
local p_grid_fe: di %9.3fc `p_fe' 
estadd local p_grid_fe `p_grid_fe'
...
regress yield_tons_hectare_2018 placebo_lai_2018, robust
local placebo = e(r2_a)
eststo: regress yield_tons_hectare_2018 max_lai_2018, robust
local placebo_r2a: di %9.3fc  `placebo'
estadd local placebo_r2a `placebo_r2a'
local p_grid_fe: di %9.3fc `p_fe' 
estadd local p_grid_fe `p_grid_fe'
...
generate yield_name = .  // Placeholder to consistently name VI coefficients in table 
label var yield_name "Vegetation index"

esttab using "tables/t5/sat_vs_fr.tex", replace se noobs ///
not label tex star(* 0.10 ** 0.05 *** 0.01) ///
noomitted nobaselevels frag b(%9.3fc) ///
mtitles("NDVI" "GCVI" "reNDVI" "MTCI" "LAI") ///
rename(max_ndvi_2018 yield_name max_gcvi_2018 yield_name max_re705_2018 yield_name max_mtci_2018 yield_name max_lai_2018 yield_name) ///
scalars("N Observations" "r2_a Adjusted \$R^2$" "placebo_r2a Placebo adjusted \$R^2$" "n_grid_fe Observations" "p_grid_fe p-value" "p_grid_fe_plcaebo Placebo p-value") ///
