...
eststo: regress fertilizers_spent treatment i.block_id, robust
...
esttab using "tables/t4/panel_a.tex", replace se noobs frag not label tex star(* 0.10 ** 0.05 *** 0.01) ///
...
mtitles("\makecell[c]{Total fertilizer \\ applied (kg/ha)}" "\makecell[c]{Distance between \\ suggested \& \\ applied fertilizer (kg/ha)}" "\makecell[c]{Fertilizer expenditures (INR)}" "\makecell[c]{Cotton yield (kg/ha)}")
...
esttab using "tables/t4/panel_b.tex", replace se noobs frag not label tex star(* 0.10 ** 0.05 *** 0.01) ///
noomitted nobaselevels scalars("N Observations" "r2_a Adjusted \$R^2$" "depMean Control mean") sfmt(%9.0fc %9.3fc %9.3fc) ///
noconstant indicate("Block FE = *block*") b(%9.3fc) ///
mtitles("\makecell[c]{Total fertilizer \\ applied (kg/ha)}" "\makecell[c]{Distance between \\ suggested \& \\ applied fertilizer (kg/ha)}" "\makecell[c]{Fertilizer expenditures (INR)}" "\makecell[c]{Cotton yield (kg/ha)}")
...
esttab using "tables/t4/panel_c.tex", replace se noobs frag not label tex star(* 0.10 ** 0.05 *** 0.01) ///
noomitted nobaselevels scalars("N Observations" "r2_a Adjusted \$R^2$" "depMean Control mean") sfmt(%9.0fc %9.3fc %9.3fc) ///
noconstant indicate("Block FE = *block*") b(%9.3fc) ///
mtitles("\makecell[c]{Total fertilizer \\ applied (kg/ha)}" "\makecell[c]{Distance between \\ suggested \& \\ applied fertilizer (kg/ha)}" "\makecell[c]{Fertilizer expenditures (INR)}" "\makecell[c]{Cotton yield (kg/ha)}")
...
esttab using "tables/t4/panel_d.tex", replace se noobs frag not label tex star(* 0.10 ** 0.05 *** 0.01) ///
noomitted nobaselevels scalars("N Observations" "r2_a Adjusted \$R^2$" "depMean Control mean") sfmt(%9.0fc %9.3fc %9.3fc) ///
noconstant indicate("Block FE = *block*") b(%9.3fc) ///
mtitles("\makecell[c]{Total fertilizer \\ applied (kg/ha)}" "\makecell[c]{Distance between \\ suggested \& \\ applied fertilizer (kg/ha)}" "\makecell[c]{Total fertilizer expenditures (INR)}" "\makecell[c]{Cotton yield (kg/ha)}")
